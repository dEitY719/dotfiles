...
[파트 독립 영역] (팀 Epic에 직접 연결되지 않는 Story)
  ...
  ├─ [AIE O-3] 조직시너지 창출 (P-3)
  │   └─ [AIE-{letter}] 조직시너지 창출 (M-3) × 9명
  ├─ [AIE O-4] 부서원역량강화 (P-4)
  │   └─ [AIE-{letter}] 개인역량강화 (M-4) × 9명
  └─ [AIE O-5] 수명업무 (P-5)       ← 평가 가중치 0% (tracking only)
...
**Summary**: `[AIE O-1] 2026 조직목표달성 - OKR 기반 핵심과제 달성`
...
**Summary**: `[AIE O-2] 2026 혁신/개선업무 - 프로세스 개선 및 AI Tool 제작`
...
**Summary**: `[AIE O-3] 2026 조직시너지 창출 - 조직 간 협업 및 기여`
...
**Summary**: `[AIE O-4] 2026 부서원역량강화 - 조직 역량 및 전문성 향상`
...
**Summary**: `[AIE O-5] 2026 수명업무 - 비계획 지시/긴급 대응 추적`
...
|----|---------|------|-------------|---------------|
| P-1 | [AIE O-1] 2026 조직목표달성 - OKR 기반 핵심과제 달성 | 50% | E4 → SWINNOTEAM-1274 | 팀 Story 하위 |
| P-2 | [AIE O-2] 2026 혁신/개선업무 - 프로세스 개선 및 AI Tool 제작 | 20% | E3 간접 | 파트 독립 |
| P-3 | [AIE O-3] 2026 조직시너지 창출 - 조직 간 협업 및 기여 | 20% | E1, E2 간접 | 파트 독립 |
| P-4 | [AIE O-4] 2026 부서원역량강화 - 조직 역량 및 전문성 향상 | 10% | E1~E4 전체 | 파트 독립 |
| P-5 | [AIE O-5] 2026 수명업무 - 비계획 지시/긴급 대응 추적 | 0% (tracking) | - | 파트 독립 |
...
│
├─ [AIE O-2] 혁신/개선업무 (P-2)                ← 신규
│   └─ [AIE-{letter}] 혁신/개선업무 (M-2) × 9명
│
├─ [AIE O-3] 조직시너지 창출 (P-3)              ← 신규
│   └─ [AIE-{letter}] 조직시너지 창출 (M-3) × 9명
│
├─ [AIE O-4] 부서원역량강화 (P-4)               ← 신규
│   └─ [AIE-{letter}] 개인역량강화 (M-4) × 9명
│
└─ [AIE O-5] 수명업무 (P-5)                     ← 신규, tracking only (0%)
    └─ (Task 만 동적 생성 — 지시 접수 시점에)
```
