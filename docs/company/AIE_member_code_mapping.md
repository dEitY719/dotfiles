...
공통 문법: **`[소속 Objective-N Key-N]`** — 계층 순 (소속 → Objective → Key).

- **M-1 (조직목표달성)**: `[AIE-{letter} O-1 K-n] 2026 조직목표달성 - OKR 기반 핵심과제 수행`
  - `n`: 담당 핵심제품 번호 (1..4) — 브라켓 맨 끝에 위치
  - 예: `[AIE-δ O-1 K-1] 2026 조직목표달성 - ...` → **명, Agent App Store 담당
- **M-2/M-3/M-4 (평가 항목)**: `[AIE-{letter} O-N] 2026 <평가 항목> - ...` (N=2..4)
  - 예: `[AIE-δ O-2] 2026 혁신/개선업무 - ...` → **명
- **P-1..P-5 (파트 Story)**: `[AIE O-N] 2026 <평가 항목> - ...` (letter 미사용)
- **P-1 하위 K Story**: `[AIE O-1 K-n] <제품명> - ...` (n=1..4)
  - 예: `[AIE O-1 K-1] SLSI Agent App Store - ...`
...
- 특정 제품 담당자 전체: `summary ~ "K-1"` → Agent App Store 담당 파트원 + K-1 파트 Story 전부
