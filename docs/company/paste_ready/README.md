...
M-1 Summary 는 `[K?-{letter} O-1]` 로 되어 있음. `?` 를 담당 핵심제품 번호(1~4)로 치환 필수:
- Agent App Store 담당 → `[K1-δ O-1]` 형태
- Alpha Agent 담당 → `[K2-δ O-1]` 형태
- Cowork 담당 → `[K3-δ O-1]` 형태
- MCP/Skill Hub 담당 → `[K4-δ O-1]` 형태
