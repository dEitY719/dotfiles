...
### Summary
```text
[AIE 파트] 2026 조직목표달성 - OKR 기반 핵심과제 달성
```
...
### Summary
```text
[AIE 파트] 2026 혁신/개선업무 - 프로세스 개선 및 AI Tool 제작
```
...
### Summary
```text
[AIE 파트] 2026 조직시너지 창출 - 조직 간 협업 및 기여
```
...
### Summary
```text
[AIE 파트] 2026 부서원역량강화 - 조직 역량 및 전문성 향상
```
...
### Summary
```text
[AIE 파트] 2026 수명업무 - 비계획 지시/긴급 대응 추적
```
