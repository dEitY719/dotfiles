...
- sections
    - commands: open_claude_plugins | list-plugins | claude-plugin-list | git-clone-skills | git-pull-skills | init-plugins-docs | sync-plugins-structure
...
- git-clone-skills     - Clone all skill repositories from the plugin manifest into the workspace
