...
# 사용 예: zsh (shell switch), zsh-theme, zsh-plugins, zsh-reload 등

# ═══════════════════════════════════════════════════════════════
# Zsh Installation (Interactive Installer)
# ═══════════════════════════════════════════════════════════════

# Install zsh with oh-my-zsh and plugins
# Runs the interactive install-zsh.sh script
install-zsh() {
...
zsh-reload() {
    if [ -f "${HOME}/.zshrc" ]; then
        ...
        # This only works if you're in zsh
        if [ -n "$ZSH" ]; then
            source "${HOME}/.zshrc"
...
_zshhelp_full() {
    ...
    ux_table_row "zsh-switch" "zsh-to" "Switch to zsh shell"
    ...
    ux_table_row "zsh-reload" "Reload zsh config (zsh only)"
    ...
    ux_bullet "Shared config: Add to ~/.bashrc and ~/.zshrc"
    ux_bullet "Shell-specific: Use ${UX_BOLD}if [ -n \"\$BASH\" ]; then ... fi${UX_RESET}"
...
export -f install-zsh zsh-switch bash-switch zsh-version zsh-themes zsh-theme zsh-theme-current
