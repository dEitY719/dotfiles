...
_claude_setup_mode=""
_claude_setup_mode_lib="${SHELL_COMMON:-${DOTFILES_ROOT:-$HOME/dotfiles}/shell-common}/util/setup_mode_read.sh"
if [ -r "$_claude_setup_mode_lib" ]; then
    # shellcheck disable=SC1091
    . "$_claude_setup_mode_lib"
