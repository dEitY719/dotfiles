    ...
    if ft == "/Tx":
        ...
        if len(states) == 2:
            ...
            if "/Off" in states:
                ...
                print(
                    f"Unexpected state values for checkbox `${field_id}`. Its checked and unchecked values may not be "
                    "correct; if you're trying to check it, visually verify the results."
                )
