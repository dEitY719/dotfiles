...
class BaseSchemaValidator:
            ...
            for file_path in all_files:
                ...
                if extension and extension not in declared_extensions:
                    ...
                    if extension in media_extensions:
                        ...
                        content_type = media_extensions[extension]
                        errors.append(
                            f"  {relative_path}: File with extension '{extension}' not declared in [Content_Types].xml "
                            f'- should add: <Default Extension="{extension}" ContentType="{content_type}"/>'
                        )
    ...
    def validate_against_xsd(self):
        ...
        if self.verbose:
            ...
            new_error_count = len([e for e in new_errors if not e.startswith("    ")])
