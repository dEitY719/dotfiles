# zsh/app/p10k.zsh: Powerlevel10k theme configuration
#
# This file is managed by dotfiles and symlinked to ~/.p10k.zsh
# To customize: Edit this file or run `p10k configure` to regenerate
#
# Note: Running `p10k configure` will regenerate this file and overwrite any manual changes.
# Keep a backup of custom configurations if needed.
#
# Generated by Powerlevel10k configuration wizard on 2025-12-30 at 08:34 KST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    virtualenv              # python virtual environment (left-side visibility like bash)
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # virtualenv            # moved to left prompt for always-visible active venv
